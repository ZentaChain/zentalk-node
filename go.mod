module github.com/ZentaChain/zentalk-node
...
// Exclude conflicting libp2p/core module - use the one embedded in libp2p v0.44.0
exclude github.com/libp2p/go-libp2p/core v0.43.0-rc2

exclude github.com/libp2p/go-libp2p/core v0.43.0-rc1
